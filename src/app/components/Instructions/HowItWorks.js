      ...
      <div className='instructions-section'>
        <div className='hiw-text'>
          ...
          <div className='title-subtext'>
            <div style={{marginBottom: 30}}>Adjust the levels of filters on different musical attributes from a specified musical selection. Calculated results are sorted and queued in the player based off of the difference between the input values and each track's actual aggregate statistics. Preview 30 second snippets from the result set and add them to your Spotify library by logging in.</div>
