...
var Portal = function (_Component) {
  ...
  function Portal() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Portal.__proto__ || Object.getPrototypeOf(Portal)).call.apply(_ref, [this].concat(args))), _this), _this.handleDocumentClick = function (e) {
      ...
      eventStack.sub('click', _this.handleDocumentClick, 'Portal');
      eventStack.sub('keydown', _this.handleEscape, 'Portal');
      ...
      eventStack.unsub('click', _this.handleDocumentClick, 'Portal');
      eventStack.unsub('keydown', _this.handleEscape, 'Portal');
